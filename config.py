dataset_config = {
    ...
    'VOC2007_TRAINVAL_URL': 'https://pjreddie.com/media/files/VOCtrainval_06-Nov-2007.tar',
    'VOC2007_TEST_URL': 'https://pjreddie.com/media/files/VOCtest_06-Nov-2007.tar',
    'VOC2012_URL': 'https://pjreddie.com/media/files/VOCtrainval_11-May-2012.tar',
    'BASE_DIR': 'data',
    'num_workers': 10,
}
